...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light shadow-sm fixed-top ">
        <div class="container ">
          <a class="navbar-brand" href="index.php"><img src="{{asset("assets/img/logo-3.png")}}" alt=""></a>
        ...
        <div class="row">
            <div class="col-md-3">
              <div class="dashboard-menu">
                <div class={{(Request::segment(2) == "dashboard" && Request::segment(3) == "") ? "dashboard-div-active"  : "dashboard-div" }} >
                  Dashboard {{Request::segment(3)}}
                </div>
                <hr/>
                <a href="{{route("employer.my-profile")}}" class="dashboard-menu-link" >
