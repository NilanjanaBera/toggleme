                                                ...
                                                <form action="{{ route('branch.create', $company->id) }}" method="post">
                                                    ...
                                                    <div class="mb-3 col-lg-12">
                                                        ...
                                                        <input type="text" class="form-control" name="branch_name"
                                                            id="exampleInputEmail1" value="{{old("branch_name")}}" aria-describedby="emailHelp">
                                                        @error('branch_name')
                                                    ...
                                                    <div class="mb-3 col-lg-12">
                                                        <label for="exampleInputEmail1" class="form-label">Branch
                                                            Description</label>
                                                        <textarea type="text" class="form-control" name="description" id="exampleInputEmail1"  aria-describedby="emailHelp">{{old("description")}}</textarea>
                                                        @error('description')
                                                            <div id="emailHelp" class="form-text text-danger">
                                                                {{ $message }} </div>
                                                        @enderror
